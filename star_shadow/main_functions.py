...
=======
    ...
    depth_snr = (d_1 / noise_level < 0.5) | (d_2 / noise_level < 0.5)
...
>>>>>>> b0e00e0c4be3a4b2faca0b23498d1af8592f94ce
    ...
    out_a = tsfit.fit_eclipse_physical(times, signal, p_orb, t_zero, ecl_par, ecl_par_err, i_sectors, verbose=verbose)
...
>>>>>>> b0e00e0c4be3a4b2faca0b23498d1af8592f94ce
    ...
    if method == 'sampler':
        ...
        out_e = tsfit.fit_eclipse_physical_sinusoid(times, signal, p_orb, t_zero, out_a[:6], const, slope,
...
>>>>>>> b0e00e0c4be3a4b2faca0b23498d1af8592f94ce
    ...
    """
    t_a = time.time()
    # signal_err = 1 # signal errors are ignored for now. The likelihood assumes the same errors and uses the MLE
...
def analyse_eclipse_timings(times, signal, signal_err, i_sectors, t_stats, target_id, save_dir, data_id='none',
    ...
    # perform checks for stopping the analysis (could be separate step at this point)
...
<<<<<<< HEAD
                                       file_name, sn_thr, bic_thr=2, method=method, **arg_dict)
=======
...
<<<<<<< HEAD
    logger.info(str(sn_thr))
    logger.info(type(sn_thr))
=======
>>>>>>> b0e00e0c4be3a4b2faca0b23498d1af8592f94ce
    # time series stats
